...
//void web(void *threadReceive)                          /*   */
void web(void *threadStructure)
{
    ...
    struct variable *tStructure = (struct variable *) threadStructure;  /*   */

    fd = tStructure->socketfd;          /*   */
    hit = tStructure->hit;                  /*   */
...
int main(int argc, char **argv)
{
    ...
    struct variable *threadStructure;            /*   */
    pthread_t Thread;

    threadpool threadPool;                       /*   */
    threadPool = create_threadpool(7);
    ...
    for(hit=1; ; hit++)
    {
        ...
        threadStructure = malloc( sizeof(struct variable) );                      /*   */

        threadStructure->socketfd = socketfd;                 /*   */
        threadStructure->hit = hit;                           /*   */


        dispatch(threadPool, web, (void *) threadStructure);
        //for(; z<16; z++)
        //{
        //dispatch(threadPool, web, (void *) threadStructure);
        //}
        //pthread_create(&threadID, NULL, web, (void*)threadStructure);      /*   */
